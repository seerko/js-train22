...
class Writer {
  ...
  restore() {
    let previousContent = Version.restore();
...
class Version {
  ...
  static create(content) {
    Version.#versions.push(new Version(content));
  }
  ...
  static restore() {
    let lastVersion = Version.#versions.pop();
    return lastVersion ? lastVersion.content : null;
  }
}
